...
ai_buffer g_cifar_model_data_map_activations[AI_CIFAR_MODEL_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 36416, 1, 1),
    36416, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_cifar_model_data_map_weights[AI_CIFAR_MODEL_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 325640, 1, 1),
    325640, NULL, s_cifar_model_weights_array_u64),   /* weights_array */
  };
...
ai_bool ai_cifar_model_data_params_get(ai_network_params* params)
{
  ...
  const ai_buffer_array map_activations = 
    AI_BUFFER_ARRAY_OBJ_INIT(AI_FLAG_NONE, AI_CIFAR_MODEL_DATA_ACTIVATIONS_COUNT, g_cifar_model_data_map_activations);
  
  const ai_buffer_array map_weights = 
    AI_BUFFER_ARRAY_OBJ_INIT(AI_FLAG_NONE, AI_CIFAR_MODEL_DATA_WEIGHTS_COUNT, g_cifar_model_data_map_weights);
